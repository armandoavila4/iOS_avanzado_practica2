...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var urlLocalDrinks: URL? = {
        var tmp = URL(string: "")
        if let documentsURL = FileManager.default.urls(for: .libraryDirectory, in: .userDomainMask).first {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "Practica2_Bebidas")
